...
# Modifying OneCycleLR to add batch_size and samples as parameters
class OneCycleLR(Callback):
    def __init__(self,
        ...
        # Initialized using class parameters
        self.epochs = epochs
    ...
    def on_train_begin(self, logs={}):
        ...
        # Changing epochs here
        self.epochs = self.epochs
        # Changing batch_size here
        self.batch_size = self.batch_size
        # Changing samples here
